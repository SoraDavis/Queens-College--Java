...
public class Date212_1 
{
	...
	public Date212_1(String dateInfo) throws Date212Exception
	{
		if(!validDate(dateInfo))
		{
			throw new Date212Exception(dateInfo);
		}
	...
	{
		if(d.length() != 8 || Integer.parseInt(d.substring(4, 6)) > 12)
		{
			return false;
		}
		 
		 if(Integer.parseInt(d.substring(4, 6)) == 4 || Integer.parseInt(d.substring(4, 6)) == 6 || Integer.parseInt(d.substring(4, 6)) == 9 || Integer.parseInt(d.substring(4, 6)) == 11)
		 {
			 if(Integer.parseInt(d.substring(6, 8)) > 30)
			 {
				 return false;
			 } 
		 }
		     ...
		     {
		    	 if(Integer.parseInt(d.substring(6, 8)) > 28)
		    	 {
		    		 return false;
		    	 }
		     }
